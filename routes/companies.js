...
const {u1Token} = require("./_testCommon")
...
router.get("/", async function (req, res, next) {
  const q = req.query
  if(q.minEmployee !== undefined) return q.minEmployee = +q.minEmployee;
  if(q.maxEmployee !== undefined) return q.maxEmployee = +q.maxEmployee;
